...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2 class="text-center mt-3">Khách trọ</h2>
            <hr>

            <a href="./CreateNewGuest">Thêm khách trọ mới</a>
                        ...
                        <tbody class="text-center small">
                            <c:forEach items="${guests}" var="guest">
                                <tr class="d-flex">
                                    ...
                                    <td class="col-sm-3">${guest.getName()}</td>
                                    <td class="col-sm-1">${guest.getGender()}</td>
                                    <td class="col-sm-1">
                                    ...
                                    <td class="col-sm-2">${guest.getHomeTown()}</td>
                                    <td class="col-sm-2">${guest.getOccupation()}</td>
                                    <td class="col-sm">
                                        <a href="./EditGuest?guest_id=${guest.getId()}">Edit</a> |  

...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2 class="text-center mt-3">Phòng trọ</h2>
            <hr>
            <a href="./CreateNewRoom">Thêm phòng trọ mới</a>
                ...
                <table class="table table-bordered mb-0">
                    <thead class="thead-dark text-center">
                        <tr class="d-flex">
                            ...
                            <th class="col-sm-3">Loại phòng</th>
                        ...
                        <tbody class="text-center">
                            <c:forEach var="room" items="${rooms}">
                                <tr class="d-flex">
                                    ...
                                    <td class="col-sm-3">${room.getName()}</td>
                                    <td class="col-sm-3">${room.getRoomType()}</td>
                                    <td class="col-sm-3">
                                        <fmt:formatNumber value="${room.getPrice()}" type="number"/> VND
                                    </td>
                                    <td class="col-sm">
                                        <a href="./EditRoom?room_id=${room.getId()}" class="small">Edit</a> |  
                                        <a href="./DeleteRoom?room_id=${room.getId()}" class="small">Delete</a>
                                    </td>
                                </tr>
